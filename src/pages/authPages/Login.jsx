...
import imgLogin from '../../assets/person3.webp';
            ...
            >
                ...
                <div className="flex flex-col justify-center p-8 lg:p-14">
                    ...
                    <div className="flex justify-between w-full py-4">
                        ...
                        <AnimateLink to="/login/forgotpassword"><span className="font-bold text-md hover:underline">Forgot password?</span></AnimateLink>
                    </div>
                    <button
                    ...
                    <div className="text-center text-gray-400">
                        ...
                        <AnimateLink to="/SignUp"><span className="ml-2 font-bold text-black hover:underline"> Sign up for free</span></AnimateLink>
